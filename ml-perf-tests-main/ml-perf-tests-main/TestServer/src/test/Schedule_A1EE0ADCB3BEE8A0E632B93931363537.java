...
public class Schedule_A1EE0ADCB3BEE8A0E632B93931363537 extends com.ibm.rational.test.lt.kernel.action.impl.Schedule {

	public Schedule_A1EE0ADCB3BEE8A0E632B93931363537(IContainer parent, String name) {
		super(parent, name, "A1EE0ADCB3BEE8A0E632B93931363537");
		super.actualScheduleName = "LockStep-Example1";
		setThinkMax(10000);
	...
	private For Loop_1(IContainer parent) {
		For forLoop = new For(parent, "Loop1", "A1EE0ADCB3C0BD7AE632B93931363537", -1, 0, 0, 0, 1, true, false, null) {
			...
			public void executeLoop() {
				...
				this.add(new test.DelaySimulation_Test_A1EE0ADB192D51C2E632B93931363537(this,
						"A1EE0ADE9C0F9B30E632B93931363537") {
					public void execute() {
						this.setRtbEnabled(false);
						super.execute();
					}
				...
				this.add(new KDelay(this, "Delay (1000 ms.)", "A1EE0ADEA2D04640E632B93931363537", 1000));
				super.executeLoop();
			}
