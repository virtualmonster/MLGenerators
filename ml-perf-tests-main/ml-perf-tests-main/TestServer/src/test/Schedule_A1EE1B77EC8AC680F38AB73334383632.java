...
public class Schedule_A1EE1B77EC8AC680F38AB73334383632 extends com.ibm.rational.test.lt.kernel.action.impl.Schedule {

	public Schedule_A1EE1B77EC8AC680F38AB73334383632(IContainer parent, String name) {
		super(parent, name, "A1EE1B77EC8AC680F38AB73334383632");
		super.actualScheduleName = "MeanStd-ConstantUsers-600ms-2200ms-Pattern";
		setThinkMax(10000);
