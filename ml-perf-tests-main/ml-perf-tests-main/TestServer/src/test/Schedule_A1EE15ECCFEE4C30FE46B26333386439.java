...
public class Schedule_A1EE15ECCFEE4C30FE46B26333386439 extends com.ibm.rational.test.lt.kernel.action.impl.Schedule {

	public Schedule_A1EE15ECCFEE4C30FE46B26333386439(IContainer parent, String name) {
		super(parent, name, "A1EE15ECCFEE4C30FE46B26333386439");
		super.actualScheduleName = "Throughput-Example1";
		setThinkMax(10000);
