    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            var doorUrl = 'http%3a%2f%2fuk-script.dotmetrics.net%2fdoor.js%3fd%3dwww.bbc.co.uk%26t%3dsearchps';
            ...
            if(!hitDone){
                ...
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=11832&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&ecid=' + ecid + dcOpt + '&c=' + hasConsent + '&tzOffset=' + tzOffset + '&doorUrl=' + doorUrl + '&dfph=' + domainFph;
                if(sf2!=null){imgUrl+='&sf2='+sf2;}
                var im=new Image;
                im.src = imgUrl;
                im.onload = function (){im.onload=null};

                var panelImgUrl = 'https://rm-script.dotmetrics.net/hit.gif?id=11832&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + ecid + '&c=' + hasConsent + '&tzOffset=' + tzOffset;
                        ...
                        window.DotMetricsSettings =
                            {
                                ...
                                DomainFingerprintUrl: 'https://uk-script.dotmetrics.net/DomainFingerprint.dotmetrics',
                                Debug: false,
                                BaseUrl: 'https://uk-script.dotmetrics.net',
                                ScriptUrl:  'https://uk-script.dotmetrics.net/Scripts/script.js?v=285',
                                ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=1b98ad80-5f5a-462d-8999-1d4b7591bebf',
                                NCSScriptUrl: 'https://uk-script.dotmetrics.net/Scripts/ncs-script.js?v=285',
                                NCSScriptDebugUrl: 'https://download.dotmetrics.net/Script/ncs-script.debug.js?v=08f32ccb-a9b5-4dad-82db-75670a41761a',
                                AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=285&id=11832',
                                SiteSectionId: 11832,
                                SiteId: 1383,
                                TimeOnPage: 'DotMetricsTimeOnPage',
                                AjaxEventTimeout: 500,
                                EventChainId:ecid,
                                DomainCookie: domainCookieData.value,
                                DomainCookieChanged: domainCookieData.changed,
                                AdexEnabled: false,
    ...
    function getDomainCookie(hasConsent){
        ...
        return {value:finalValue,changed:dcChanged};
    }
    ...
    function getDomainFph(hasConsent) {
        ...
        if(window.localStorage){
            try{
                return JSON.parse(window.localStorage.getItem('DotmetricsDomainFPH')).dfph;
            }catch(e) {
                return '';
            }
        }
